# BTC : Double Timeframe Strategy Design
...
def main():
    ...
    # Loading data
    data_slow = pd.read_csv(r"./data/BTC/BTC_2019_2023_1d.csv")
    data_fast = pd.read_csv(r"./data/BTC/BTC_2019_2023_15m.csv")
    ...
    csv_file_path = "btc_1_result.csv"
